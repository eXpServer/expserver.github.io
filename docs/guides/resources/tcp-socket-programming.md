...
::: tip Before looking into what TCP is, and its significance in networking, you should have a proper understanding of the layers in the TCP/IP model and how they are interconnected.
:::
